...
activities = {
    ...
    "Swimming Club": {
        "description": "Swim laps and work on competitive stroke techniques",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and theatrical performance",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["isabella@mergington.edu", "lucas@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Prepare for science challenges and compete in STEM events",
